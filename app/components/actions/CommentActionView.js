...
class CommentActionView extends Component {
  propTypes: {
    dispatch: PropTypes.func.isRequired,
    isCommentActionViewOpen: PropTypes.bool.isRequired
  }
  ...
  render() {
    const { isCommentActionViewOpen } = this.props;

    if (!isCommentActionViewOpen) {
      return false;
    }
    return (
      <Modal
        onRequestClose={this.onCancel}
        visible={isCommentActionViewOpen}
        animationType={'slide'}
      >
...
export default connect(select)(CommentActionView);
